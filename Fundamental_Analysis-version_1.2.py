...
URL_shares = (f"https://www.moneycontrol.com/financials/{company_name}/capital-structure/{company_code}#{company_code}")
response = rq.get(URL_shares)
...
URL_non_liability = (f"https://www.moneycontrol.com/financials/{company_name}/balance-sheetVI/{company_code}#{company_code}")
response = rq.get(URL_non_liability)
table = pd.read_html(response.text)
Non_Current_Liability = float(table[0][(1)][(14)])

# Taking Enterprise Values of past year in crores
URL_EV_and_EBIDTDA = (f"https://www.moneycontrol.com/financials/{company_name}/ratiosVI/{company_code}#{company_code}")
response = rq.get(URL_EV_and_EBIDTDA)
table = pd.read_html(response.text)
...
# print(f"Total Number of shares is {URL_shares}")
print(f"Total Number of shares is {Total_numbers_of_shares}\n")

# print(f"Total Number of shares is {URL_non_liability}")
# print(f"Non-Current Liability is {Non_Current_Liability}\n")

# print(f"Total Number of shares is {URL_EV_and_EBIDTDA}")
# print(f"Enterprsie value {Present_year} {Present_year-1} {Present_year-2} {Present_year-3} {Present_year-4}")
# print(f"{Present_year_Enterprise_value} {Present_year_minus_one_Enterprise_value} {Present_year_minus_two_Enterprise_value} {Present_year_minus_three_Enterprise_value} {Present_year_minus_four_Enterprise_value}\n")
# print(f"EV/EBITDA {Present_year} {Present_year-1} {Present_year-2} {Present_year-3} {Present_year-4}")
# print(f"{Present_year_EV_by_EBITDA} {Present_year_minus_one_EV_by_EBITDA} {Present_year_minus_two_EV_by_EBITDA} {Present_year_minus_three_EV_by_EBITDA} {Present_year_minus_four_EV_by_EBITDA}")
# ------------------------------------------------------------------------------------------------------------------------------------
